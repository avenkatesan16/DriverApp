...
//	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			protected PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("avenkatesan@msystechnologies.com", "weswmzjkvoqmrjbm");
			}
		});
		// compose message
		try {
		...
		try {
			...
			msg.setReplyTo(InternetAddress.parse("avenkatesan@msystechnologies.com", false));

			msg.setSubject("Test Report by Automation", "UTF-8");

			msg.setSentDate(new Date());

			msg.setRecipients(Message.RecipientType.TO, InternetAddress.parse("avenkatesan@msystechnologies.com"));
...
//			Thread.sleep(10000);
			...
			String filename = System.getProperty("user.dir")
					+ "\\test-output\\HtmlReport\\HtmlReport.html";
			...
			String zipFile = System.getProperty("user.dir") + "/test-output/CucumberExtentReport.zip";
			...
			String filename2 = System.getProperty("user.dir") + "/test-output/CucumberExtentReport.zip";
